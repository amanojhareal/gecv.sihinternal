 ...
 * Icon-only, kept separate from NavLinks per the original spec.
 * Mail is the clearest one-glance icon for "contact" — kept as-is,
 * just tightened to match NavLinks' new sizing/spacing rhythm.
 */
